 ...
 * @generated */
public class ConceptWindow extends Window {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ConceptWindow.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ConceptWindow() {/* intentionally empty block */}
   ...
   */
  public ConceptWindow(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public ConceptWindow(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public ConceptWindow(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
