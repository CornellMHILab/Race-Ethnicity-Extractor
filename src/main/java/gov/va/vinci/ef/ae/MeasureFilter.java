 ...
 */
public class MeasureFilter extends LeoBaseAnnotator {
   ...
   */
  protected WindowService windowService = new WindowService(5, 5, Window.class.getCanonicalName());
  ...
  public void annotate(JCas aJCas) throws AnalysisEngineProcessException {
    ...
    Collection<Measurement> values = AnnotationLibrarian.getAllAnnotationsOfType(aJCas, Measurement.type, false);
  ...
  public MeasureFilter setRegexFilePath(String regexFilePath) {
