 ...
 */
public abstract class MeasureValidatorAnnotator extends LeoBaseAnnotator {


  /**
   * Pattern for finding numbers in the covered text.
   */
  protected Pattern valuePattern = Pattern.compile(".*");
    ...
    for (String inputType : inputTypes) {
      try {
        ...
        for (Annotation a : annotations) {
          ...
          Matcher m = valuePattern.matcher(covered);
  ...
  public MeasureValidatorAnnotator setRemoveIfAnyInvalid(boolean removeIfAnyInvalid) {
