...
public class PipelineTest {
  ...
  public void testSimple() throws Exception {
    String docText = "Various unrelated text. 47 yo African American male for physical. Various unrelated text. ";
    ...
    if (aList.hasNext()) {
      ...
      Assert.assertEquals(r.getRace(), "black");
      Assert.assertEquals(r.getTerm(), "African American");
  ...
  public void testSimple2() throws Exception {
    String docText = "Various unrelated text. Hispanic female 32 year old. Various unrelated text. ";
    AnalysisEngine ae = UIMAFramework.produceAnalysisEngine(aggregate.getAnalysisEngineDescription());
    JCas jcas = ae.newJCas();
    jcas.setDocumentText(docText);
    ae.process(jcas);
    ...
    if (aList.hasNext()) {
      Relation r = (Relation) aList.next();
      Assert.assertEquals(r.getEthnicity(), "hispanic");
      Assert.assertEquals(r.getTerm(), "Hispanic");
      Assert.assertFalse(aList.hasNext());
    }
  }
